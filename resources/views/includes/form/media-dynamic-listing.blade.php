...
<x-bs-input :class="$options['hasName'] ? 'w-50 mr-2' : 'w-100 mr-2'" :label="__('sp::field.file')" :name="'media_to_update['.$item->id.'][file]'" :value="$item->filename" readonly :input-group="$options['hasDownload']">
