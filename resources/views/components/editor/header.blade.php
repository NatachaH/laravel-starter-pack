<div class="ql-formats btn-group">
    ...
    <button type="button" class="btn dropdown-toggle ql-dropdown-header" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="@lang('sp::editor.heading')">
