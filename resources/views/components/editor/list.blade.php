<div class="ql-formats btn-group">
    ...
    <button class="btn ql-list" value="ordered" aria-label="@lang('sp::editor.list-ordered')">
    ...
    <button class="btn ql-list" value="bullet" aria-label="@lang('sp::editor.list-bullet')">
