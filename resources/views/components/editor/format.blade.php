<div class="ql-formats btn-group">
    ...
    <button class="btn ql-bold" aria-label="@lang('sp::editor.bold')">
    ...
    <button class="btn ql-italic" aria-label="@lang('sp::editor.italic')">
    ...
    <button class="btn ql-underline" aria-label="@lang('sp::editor.underline')">
    ...
    <button class="btn ql-strike" aria-label="@lang('sp::editor.strike')">
