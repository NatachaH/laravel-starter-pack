<div class="ql-formats btn-group">
    ...
    <button type="button" class="btn dropdown-toggle ql-dropdown-color" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="@lang('sp::editor.color')">
    ...
    <div class="dropdown-menu p-0" >
      ...
      <div class="btn-group">
        ...
        @foreach ($colors as $color)
            ...
            <button class="ql-color btn" value="{{ $color }}">
              <svg class="bi bi-square-fill text-{{ $color }}" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
